    ...
    <div>
      ...
      <Container style={{
        ...
        <div className='text-break border py-4 px-4'>
          ...
          <div style={{ width: "100%" }}>
            <div className='d-flex text-muted justify-content-end' style={{ fontSize: "1rem" }}>
              <span>작성자&nbsp;</span>
              <span>관리자</span>
          ...
          <div className={isFile ? 'd-flex justify-content-between align-items-center mt-3 p-4 bg-light down_a' : 'd-none'}>
            <div>
