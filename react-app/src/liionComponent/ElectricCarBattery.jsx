  ...
  return (
    ...
    <div class="con_12">
          ...
          <div class="sub3_title align-self-center">
            <h6 className='mt-5 g'>최근 전기차 시장이 점차 확대되면서 전기차의 동력원인 리튬이온 배터리에 대해서도 관심이 많아지고 있습니다.
...
'배터리 셀', '배터리 모듈', '배터리 팩' 평소엔 '배터리'라고 통칭하기도 하지만 사실은 조금씩 다른 걸 지칭하는 말인데요.
          ...
          <div class="sub4_title d-flex flex-wrap ">
            ...
            <h6 className='mt-5 mb-5 g flex-grow-1 border-top border-bottom border-2 py-5 border-dark'> 전기차 가동을 위해서는 스마트폰의 수천 배에 달하는 엄청난 양의 전력이 필요합니다.
...
전기차에는 최종적으로 배터리가 하나의 팩 형태로 들어가게 됩니다.
          ...
          <div class="sub4_title d-flex flex-wrap flex-row-reverse">
            ...
            <div class="col-sm-6 align-self-center">
            <h6 className='mt-5 mb-5 g flex-grow-1 border-top border-bottom border-2 py-5 border-dark'> 대표적인 순수 전기차(EV) BMW i3의 배터리를 예로 들어 볼까요? BMW i3에는 배터리 셀이 총 96개 탑재됩니다.
