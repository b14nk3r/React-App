  ...
  return (
    ...
    <div>
      ...
      <div class="sub3_title align-self-center">
        ...
        <h6
          data-aos="fade-down"
          className='mt-5 sub_title4'>ESS는 생산된 전력에너지를 배터리에 저장한 뒤 이후 전력이 필요한 시기에 저장된 전력을 공급하여
      ...
      <div class="sub3_title align-self-center">
        ...
        <h6
          data-aos="fade-down"
          className='mt-5 sub_title4'>ESS는 효율적인 전력 활용 고품질의 전력 확보 안정적인 전력 공급 측면에서 그 필요성이 증대되고 있습니다.
      ...
      <div class="sub3_title align-self-center">
        ...
        <h6
          data-aos="fade-down"
          className='mt-5 sub_title4'>SS는 전력수요가 적은 심야시간에 전기에너지를 배터리에 저장하고 전력수요가 많은 피크시간에 방전 하면서
      ...
      <div class="sub3_title align-self-center mb-5">

        <h6
          data-aos="fade-down"
          className='mt-5 sub_title4'>ESS가 에너지 저장 시스템이기 때문에 ESS 자체를 배터리라고 알고 계시지만,
