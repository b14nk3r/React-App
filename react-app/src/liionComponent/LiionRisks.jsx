    ...
    <div>
      ...
      <div class="sub4_title d-flex flex-wrap flex-row-reverse">
        ...
        <div class="col-sm-6 align-self-center">
          ...
          <h6
            data-aos="zoom-in"
            className='mt-5 mb-5 flex-grow-1 border-top border-bottom border-2 py-5 border-dark sub_title4'> 과충전은 배터리의 정상적인 작동전압 이상으로 충전되는 현상으로서
      ...
      <div class="sub4_title d-flex flex-wrap ">
        ...
        <div class="col-sm-6 align-self-center">
          ...
          <h6
           data-aos="zoom-in"
            className='mt-5 mb-5 flex-grow-1 border-top border-bottom border-2 py-5 border-dark sub_title4'>방전이란 음극인 흑연에서 리튬이온이 빠져나가는 현상이며,
      ...
      <div class="sub4_title d-flex flex-wrap">
        ...
        <div class="col-sm-6 align-self-center">
          ...
          <h6
            data-aos="zoom-in"
            className='mt-5 mb-5 flex-grow-1 border-top border-bottom border-2 py-5 border-dark sub_title4'> 리튬이온 배터리가 찍힘, 놀림, 꺾임, 과도한 압력 등의 물리적 손상을 입는 경우
